...
def iCalc(source, side):
    storeObj = Frame(source, borderwidth=4,bd=4,bg="lightseagreen")
...
class app (Frame):
    def __init__(self):
        ...
        self.master.title('Calculator---by TS')


        display = StringVar()
        Entry(self, relief =GROOVE,
              textvariable=display,justify='right',bd=30,bg="lightseagreen").pack(side=TOP, expand=YES,
                                                                                 fill=BOTH)
